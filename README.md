...
<p>
<a href="https://github.com/Thrasno/conpas-ai/releases"><img src="https://img.shields.io/github/v/release/Thrasno/conpas-ai" alt="Release"></a>
...
```bash
brew tap Thrasno/homebrew-tap
brew install conpas-ai
```

### Go install (any platform with Go 1.24+)

```bash
go install github.com/Thrasno/conpas-ai/cmd/conpas-ai@latest
```
...
Download the binary for your platform from [GitHub Releases](https://github.com/Thrasno/conpas-ai/releases).
...
| Topic | Description |
|-------|-------------|
| [Intended Usage](docs/intended-usage.md) | How conpas-ai is meant to be used — the mental model |
